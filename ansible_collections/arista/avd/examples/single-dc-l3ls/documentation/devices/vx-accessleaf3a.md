...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.151.11.19/26 | 10.151.11.1 |
...
| --------- | --------------- | ------------ | --------- |
| ACCESSLEAF3 | Vlan4094 | 10.100.54.105 | Port-Channel491 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet45 | VX-SUBLEAF5B_Ethernet1/1 | *trunk | *10,1202,1213,1250 | *- | *- | 46 |
| Ethernet46 | VX-SUBLEAF5A_Ethernet1/1 | *trunk | *10,1202,1213,1250 | *- | *- | 46 |
| Ethernet47 | VX-SUBLEAF4B_Ethernet56 | *trunk | *10,1202,1213,1250 | *- | *- | 48 |
| Ethernet48 | VX-SUBLEAF4A_Ethernet56 | *trunk | *10,1202,1213,1250 | *- | *- | 48 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_VX-SPINE1_Ethernet1 | routed | - | 10.100.54.49/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_VX-SPINE2_Ethernet1 | routed | - | 10.100.54.51/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_VX-SPINE1_Ethernet1
   no shutdown
   mtu 9214
   no switchport
   ip address 10.100.54.49/31
!
interface Ethernet2
   description P2P_LINK_TO_VX-SPINE2_Ethernet1
   no shutdown
   mtu 9214
   no switchport
   ip address 10.100.54.51/31
!
interface Ethernet45
   description VX-SUBLEAF5B_Ethernet1/1
   no shutdown
   channel-group 46 mode active
!
interface Ethernet46
   description VX-SUBLEAF5A_Ethernet1/1
   no shutdown
   channel-group 46 mode active
!
interface Ethernet47
   description VX-SUBLEAF4B_Ethernet56
   no shutdown
   channel-group 48 mode active
!
interface Ethernet48
   description VX-SUBLEAF4A_Ethernet56
   no shutdown
   channel-group 48 mode active
!
interface Ethernet49/1
   description MLAG_PEER_vx-accessleaf3b_Ethernet49/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet50/1
   description MLAG_PEER_vx-accessleaf3b_Ethernet50/1
   no shutdown
   channel-group 491 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel46 | VX-SUBLEAF5_Po11 | switched | trunk | 10,1202,1213,1250 | - | - | - | - | 46 | - |
| Port-Channel48 | VX-SUBLEAF4_Po56 | switched | trunk | 10,1202,1213,1250 | - | - | - | - | 48 | - |
...
interface Port-Channel491
   description MLAG_PEER_vx-accessleaf3b_Po491
   no shutdown
   switchport
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.100.160.7/32 |
...
| Vlan3009 |  VRF10  |  10.100.54.120/31  |  -  |  -  |  -  |  -  |  -  |
...
!
interface Vxlan1
   description vx-accessleaf3a_VTEP
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 10.100.54.48 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.100.54.50 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.100.54.121 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| 10.100.54.121 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.100.160.7:10010 | 10010:10010 | - | - | learned |
| 1202 | 10.100.160.7:11202 | 11202:11202 | - | - | learned |
| 1213 | 10.100.160.7:11213 | 11213:11213 | - | - | learned |
| 1250 | 10.100.160.7:11250 | 11250:11250 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF10 | 10.100.160.7:10 | connected |
...
router bgp 65103
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description vx-accessleaf3b
   neighbor MLAG-IPv4-UNDERLAY-PEER password 7 <removed>
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 10.100.54.48 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.100.54.48 remote-as 65100
   neighbor 10.100.54.48 description vx-spine1_Ethernet1
   neighbor 10.100.54.50 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.100.54.50 remote-as 65100
   neighbor 10.100.54.50 description vx-spine2_Ethernet1
   neighbor 10.100.54.121 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.100.54.121 description vx-accessleaf3b
   ...
   !
   vlan 10
      rd 10.100.160.7:10010
      route-target both 10010:10010
      redistribute learned
   !
   vlan 1202
      rd 10.100.160.7:11202
      route-target both 11202:11202
      redistribute learned
   !
   vlan 1213
      rd 10.100.160.7:11213
      route-target both 11213:11213
      redistribute learned
   !
   vlan 1250
      rd 10.100.160.7:11250
