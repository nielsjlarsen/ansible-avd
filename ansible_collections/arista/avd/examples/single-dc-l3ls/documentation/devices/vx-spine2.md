...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.151.11.18/26 | 10.151.11.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_VX-ACCESSLEAF3A_Ethernet2 | routed | - | 10.100.54.50/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_VX-ACCESSLEAF3B_Ethernet2 | routed | - | 10.100.54.54/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_VX-BORDERLEAF2A_Ethernet2 | routed | - | 10.100.54.42/31 | default | 9214 | False | - | - |
| Ethernet4 | P2P_LINK_TO_VX-BORDERLEAF2B_Ethernet2 | routed | - | 10.100.54.46/31 | default | 9214 | False | - | - |
| Ethernet5 | P2P_LINK_TO_VX-BORDERLEAF1A_Ethernet2 | routed | - | 10.100.54.34/31 | default | 9214 | False | - | - |
| Ethernet6 | P2P_LINK_TO_VX-BORDERLEAF1B_Ethernet2 | routed | - | 10.100.54.38/31 | default | 9214 | False | - | - |
| Ethernet7 | P2P_LINK_TO_VX-WIFI1A_Ethernet28 | routed | - | 10.100.54.58/31 | default | 9214 | False | - | - |
| Ethernet8 | P2P_LINK_TO_VX-WIFI1B_Ethernet28 | routed | - | 10.100.54.62/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_VX-ACCESSLEAF3A_Ethernet2
   no shutdown
   mtu 9214
   no switchport
   ip address 10.100.54.50/31
!
interface Ethernet2
   description P2P_LINK_TO_VX-ACCESSLEAF3B_Ethernet2
   no shutdown
   mtu 9214
   no switchport
   ip address 10.100.54.54/31
!
interface Ethernet3
   description P2P_LINK_TO_VX-BORDERLEAF2A_Ethernet2
   no shutdown
   mtu 9214
   no switchport
   ip address 10.100.54.42/31
!
interface Ethernet4
   description P2P_LINK_TO_VX-BORDERLEAF2B_Ethernet2
   no shutdown
   mtu 9214
   no switchport
   ip address 10.100.54.46/31
!
interface Ethernet5
   description P2P_LINK_TO_VX-BORDERLEAF1A_Ethernet2
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet6
   description P2P_LINK_TO_VX-BORDERLEAF1B_Ethernet2
   no shutdown
   mtu 9214
   no switchport
   ip address 10.100.54.38/31
!
interface Ethernet7
   description P2P_LINK_TO_VX-WIFI1A_Ethernet28
   no shutdown
   mtu 9214
   no switchport
   ip address 10.100.54.58/31
!
interface Ethernet8
   description P2P_LINK_TO_VX-WIFI1B_Ethernet28
   no shutdown
   mtu 9214
   no switchport
   ip address 10.100.54.62/31
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.100.160.2/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 10.100.54.35 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.100.54.39 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.100.54.43 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.100.54.47 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.100.54.51 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.100.54.55 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.100.54.59 | 65104 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.100.54.63 | 65104 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65100
   ...
   neighbor 10.100.54.35 remote-as 65101
   neighbor 10.100.54.35 description vx-borderleaf1a_Ethernet2
   neighbor 10.100.54.39 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.100.54.39 remote-as 65101
   neighbor 10.100.54.39 description vx-borderleaf1b_Ethernet2
   neighbor 10.100.54.43 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.100.54.43 remote-as 65102
   neighbor 10.100.54.43 description vx-borderleaf2a_Ethernet2
   neighbor 10.100.54.47 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.100.54.47 remote-as 65102
   neighbor 10.100.54.47 description vx-borderleaf2b_Ethernet2
   neighbor 10.100.54.51 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.100.54.51 remote-as 65103
   neighbor 10.100.54.51 description vx-accessleaf3a_Ethernet2
   neighbor 10.100.54.55 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.100.54.55 remote-as 65103
   neighbor 10.100.54.55 description vx-accessleaf3b_Ethernet2
   neighbor 10.100.54.59 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.100.54.59 remote-as 65104
   neighbor 10.100.54.59 description vx-wifi1a_Ethernet28
   neighbor 10.100.54.63 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.100.54.63 remote-as 65104
   neighbor 10.100.54.63 description vx-wifi1b_Ethernet28
