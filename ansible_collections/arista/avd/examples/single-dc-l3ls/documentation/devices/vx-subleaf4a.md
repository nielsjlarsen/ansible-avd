...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.151.11.15/26 | 10.151.11.1 |
...
| --------- | --------------- | ------------ | --------- |
| VX-SUBLEAF4 | Vlan4094 | 10.100.54.129 | Port-Channel49 |
...
| Ethernet55 | VX-ACCESSLEAF3B_Ethernet48 | *trunk | *10,20 | *- | *- | 56 |
| Ethernet56 | VX-ACCESSLEAF3A_Ethernet48 | *trunk | *10,20 | *- | *- | 56 |
...
interface Ethernet50
   description MLAG_PEER_vx-subleaf4b_Ethernet50
   no shutdown
   channel-group 49 mode active
!
interface Ethernet55
   description VX-ACCESSLEAF3B_Ethernet48
   no shutdown
   channel-group 56 mode active
!
interface Ethernet56
   description VX-ACCESSLEAF3A_Ethernet48
   no shutdown
   channel-group 56 mode active
```
...
interface Port-Channel49
   description MLAG_PEER_vx-subleaf4b_Po49
   no shutdown
   switchport
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan4094 |  default  |  10.100.54.128/31  |  -  |  -  |  -  |  -  |  -  |
