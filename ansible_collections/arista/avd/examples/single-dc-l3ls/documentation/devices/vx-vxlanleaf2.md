...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1/1 | VX-BORDERLEAF2A_Ethernet4 | *trunk | *11,1213,1250 | *- | *- | 11 |
| Ethernet1/2 | VX-BORDERLEAF2B_Ethernet4 | *trunk | *11,1213,1250 | *- | *- | 11 |
...
interface Ethernet1/1
   description VX-BORDERLEAF2A_Ethernet4
   no shutdown
   channel-group 11 mode active
!
interface Ethernet1/2
   description VX-BORDERLEAF2B_Ethernet4
   no shutdown
   channel-group 11 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel11 | BORDERLEAF2_Po4 | switched | trunk | 11,1213,1250 | - | - | - | - | - | - |
...
!
interface Vxlan1
  description vx-vxlanleaf2_VTEP
  vxlan source-interface Loopback1
  vxlan udp-port 4789
  vxlan flood vtep learned data-plane
  vxlan vlan 1213 vni 1213
  vxlan vlan 1250 vni 1250
  vxlan bridging vtep-to-vtep source-vtep tx disabled 10.100.54.25
interface Port-Channel11
  switchport trunk allowed vlan 102,1213,1250
no vlan 11
vlan 102
  name BORDER2-LINKNET
interface vlan 102
  ip address 10.100.55.12/29
interface Loopback0
  ip address 10.100.160.11/32
interface Loopback1
  ip address 10.100.160.12/32
router bgp 65105
  router-id 10.100.160.11
  ...
  neighbor 10.100.55.11 peer group IPv4-UNDERLAY-PEERS
  neighbor 10.100.55.11 remote-as 65102
  neighbor 10.100.55.11 description vx-borderleaf2
